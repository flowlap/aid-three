...
const FILENAME = "image-common-prompt.txt";

/** Saves the project-wide style guide (character, palette, background, concept...) folded into every image generation prompt. */
